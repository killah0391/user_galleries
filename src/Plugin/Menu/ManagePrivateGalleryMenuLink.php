<?php
// File: user_match/src/Plugin/Menu/ManagePrivateGalleryMenuLink.php
 ...
 */
class ManagePrivateGalleryMenuLink extends MenuLinkDefault
{
  ...
  /**
   * Constructs a new ManagePrivateGalleryMenuLink object.
   */
  ...
  {
    return 'user_galleries.manage_private';
  }
  ...
  public function getTitle()
  {
    if ($this->currentUser->isAuthenticated()) {
      ...
      return $this->t('Manage private gallery');
    }
